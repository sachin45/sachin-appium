...
/**
 * This class generates email reports(Custom TestNG report)
 */
...
//			String customReportTitle = this.getCustomReportTitle("Summary Report");
            ...
            String outputReportDirectory = System.getProperty("user.dir") + "/test-output/";
            ...
            File targetFile = new File(outputReportDirectory + "Automation -TestSummaryReport.html");
...
//					String skippedTestCases = "";
                    ...
                    /* Passed Test Case Names -- Updated by Himadri */
//					for(ITestNGMethod passedMethod : testObj.getPassedTests().getAllMethods()) {
//						if(passedTestCases == "") {
//							passedTestCases = " - " + passedMethod.getMethodName();
//						}else {
//							passedTestCases = passedTestCases + "<BR/> - " + passedMethod.getMethodName();
//						}
//					}

                    /* Failed Test Case Names -- Updated by Himadri */
//					for(ITestNGMethod failedMethod : testObj.getFailedTests().getAllMethods()) {
//						if(failedTestCases == "") {
//							failedTestCases = " - " + failedMethod.getMethodName();
//						}else {
//							failedTestCases = failedTestCases + "<BR/> - " + failedMethod.getMethodName();
//						}
//					}


                    /* Skipped Test Case Names -- Updated by Himadri */
//					for(ITestNGMethod skippedMethod : testObj.getSkippedTests().getAllMethods()) {
//						if(skippedTestCases == "") {
//							skippedTestCases = " - " + skippedMethod.getMethodName();
//						}else {
//							skippedTestCases = skippedTestCases + "<BR/> - " + skippedMethod.getMethodName();
//						}
//					}
                    ...
                    /* Passed Test Cases -- Updated by Himadri */
//					retBuf.append("<td>");
//					retBuf.append(passedTestCases);
//					retBuf.append("</td>");

                    /* Failed Test Cases -- Updated by Himadri */
//					retBuf.append("<td>");
//					retBuf.append(failedTestCases);
//					retBuf.append("</td>");
